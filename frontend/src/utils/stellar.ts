...
// Contract addresses
export const FACTORY_ADDRESS = cleanEnv(import.meta.env.VITE_FACTORY_CONTRACT_ADDRESS) || 'CD3XTRCKMI6DFJ4E76T7SNQ6RCEI6LLJMLHXVFOA7JQ4V2TZRCSCKRGB';
...
export const TOKEN_ADDRESS = rawTokenAddr;
